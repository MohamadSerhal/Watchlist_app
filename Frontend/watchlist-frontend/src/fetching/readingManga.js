...
export default function ReadingManga() {
        ...
        return <Container style={{ marginLeft:'30px'}} fluid> 
                    <Row style= {{ padding: '10px'}}>
                        ...
                        <Col>
                            ...
                            <Button style={{marginTop: '10px'}} onClick={() => changeStatus(props.identification, "to read")}>Set as To Read</Button>
                        </Col>
    ...
    function getReadingManga() {
        fetch(`${SERVER_URL}/manga/reading`)
    ...
    useEffect( () => { getReadingManga() }, []);

    return(  
        <div>
            <p style={{marginRight: '300px', marginLeft: '300px', fontSize: '30px'}}> <strong>Reading</strong></p>
