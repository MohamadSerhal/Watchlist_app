...
export default function ToWatchAnime() {
    ...
    function getToWatchedAnime() {
        fetch(`${SERVER_URL}/anime/toWatch`)
    ...
    useEffect( () => { getToWatchedAnime() }, []);

    return(  
        <div>
            <p style={{marginRight: '300px', marginLeft: '300px', fontSize: '30px'}}> <strong>To Watch</strong></p>
