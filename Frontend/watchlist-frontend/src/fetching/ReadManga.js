...
export default function ReadManga() {
    ...
    function getReadManga() {
        fetch(`${SERVER_URL}/manga/read`)
    ...
    useEffect( () => { getReadManga() }, []);

    return(  
        <div>
            <p style={{marginRight: '300px', marginLeft: '300px', fontSize: '30px'}}> <strong>Read</strong></p>
